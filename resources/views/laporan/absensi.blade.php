...
@section('title', 'Rekap Absensi - MTs Syafiiyah')
...
<div class="w-full px-4 md:px-6 py-6">
    ...
    <div class="luxury-card p-5 mb-6">
        <form method="GET" action="{{ route(auth()->user()->role . '.laporan.absensi') }}" class="m-0 flex flex-col md:flex-row gap-4 items-end">
                ...
                <table class="w-full luxury-table min-w-[750px]">
                    <thead class="border-b border-white/10 bg-white/5">
                        <tr>
                            ...
                            <th class="text-center p-4 text-white/60 text-xs font-semibold uppercase tracking-wider">Total Sesi</th>
                            <th class="text-center p-4 text-white/60 text-xs font-semibold uppercase tracking-wider">Kehadiran (%)</th>
                        </tr>
                    </thead>
                    <tbody>
