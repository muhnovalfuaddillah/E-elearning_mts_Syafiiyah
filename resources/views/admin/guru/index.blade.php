    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
        <div class="luxury-card p-3 md:p-5">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-blue-400 text-xs md:text-sm mt-2"><i class="fas fa-user-tie"></i> Aktif</p>
                </div>
        ...
        <div class="luxury-card p-3 md:p-5">
            <div class="flex justify-between items-start">
                ...
                <div class="luxury-icon w-10 h-10 md:w-12 md:h-12 bg-blue-500/20">
                    <i class="fas fa-book-open text-blue-400 text-base md:text-xl"></i>
                </div>
            </div>
        </div>
    </div>
        ...
        <form method="GET" action="{{ route('admin.guru.index') }}" id="searchForm">
            <div class="flex flex-col md:flex-row gap-3">
                ...
                <div class="w-full md:w-48">
                    <select name="jenis_kelamin" onchange="document.getElementById('searchForm').submit()" class="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-white focus:border-blue-500 focus:outline-none text-sm md:text-base">
                ...
                <div class="w-full md:w-40">
                    <select name="sort_by" onchange="document.getElementById('searchForm').submit()" class="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-white focus:border-blue-500 focus:outline-none text-sm md:text-base">
    ...
    <div class="luxury-card overflow-hidden">
        ...
        <div class="p-4 border-t border-white/10 flex justify-between items-center flex-wrap gap-4">
            ...
            <div class="flex gap-2">
                ...
                @else
                    <a href="{{ $gurus->previousPageUrl() }}" class="px-3 py-1 rounded-lg bg-white/5 text-white/60 text-sm hover:bg-blue-500/20 transition">
                        <i class="fas fa-chevron-left"></i>
                    </a>
                @endif
                ...
                @if($gurus->hasMorePages())
                    <a href="{{ $gurus->nextPageUrl() }}" class="px-3 py-1 rounded-lg bg-white/5 text-white/60 text-sm hover:bg-blue-500/20 transition">
    ...
    <div class="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl w-full max-w-[95%] md:max-w-lg mx-4 my-8 shadow-2xl border border-white/10">
        ...
        <form action="{{ route('admin.guru.store') }}" method="POST">
            ...
            <div class="p-4 md:p-6 border-t border-white/10 flex gap-3 justify-end">
                ...
                <button type="submit" class="px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg text-white font-semibold text-sm flex items-center gap-2">
