                                ...
                                <div class="luxury-card p-5 hover:border-purple-500/30 transition-all flex flex-col justify-between">
                                    <div>
                                        <div class="flex justify-between items-start gap-4">
                                            <span class="px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider bg-pink-500/20 text-pink-400 border border-pink-500/30">
                                        ...
                                        <div class="mt-4 p-3 bg-white/5 rounded-xl border border-white/5 space-y-1 text-xs">
                                            ...
                                            <div class="flex justify-between">
                                                ...
                                                <span class="font-semibold {{ $isOverdue ? 'text-red-400' : 'text-purple-400' }}">
                                    ...
                                    <div class="mt-6 pt-4 border-t border-white/5 space-y-3">
                                        @if($hasSubmitted)
                                            <div class="p-3 bg-emerald-500/5 border border-emerald-500/10 rounded-xl space-y-2 text-xs">
                                                ...
                                                @if($submission->nilai)
                                                    <div class="flex justify-between pt-2 border-t border-white/5">
                                                        ...
                                                        <span class="text-emerald-400 font-bold text-sm">{{ $submission->nilai }}</span>
                                                    </div>
                                                @endif
                                        ...
                                        @if(!$isOverdue)
                                            <button onclick="openSubmitModal({{ $item->id }}, '{{ addslashes($item->judul) }}')" class="w-full py-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:opacity-90 rounded-lg text-white font-semibold text-xs transition flex items-center justify-center gap-1.5 shadow-glow">
...
<div id="submitModal" class="fixed inset-0 z-[1000] hidden items-center justify-center p-4">
    ...
    <div class="relative bg-gradient-to-br from-slate-900 to-slate-950 border border-white/10 rounded-2xl w-full max-w-md p-6 overflow-hidden">
        <div class="flex justify-between items-center mb-4 pb-3 border-b border-white/10">
            <h5 class="text-white font-bold text-lg"><i class="fas fa-upload text-purple-400 mr-1.5"></i> Pengumpulan Tugas</h5>
