...
class MateriController extends Controller
{
    ...
    {
        $query = Materi::with('kelas', 'mapel', 'user');
        ...
        return view('admin.materi.index', compact('materi', 'kelas', 'mapels'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // Harus ada setidaknya file atau link video jika bukan materi teks murni
    ...
    public function update(Request $request, $id)
    {
        ...
        // Jika link video terisi dan tidak ada file baru, ubah tipe ke video (jika sebelumnya bukan pdf/ppt yang tetap dipertahankan)
